...
import (
	...
	versioned "k8s.io/rules/pkg/client/clientset/versioned"
	internalinterfaces "k8s.io/rules/pkg/client/informers/externalversions/internalinterfaces"
	v1 "k8s.io/rules/pkg/client/listers/crd/v1"
	time "time"
)
...
func (f *ruleInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&crd_v1.Rule{}, f.defaultInformer)
}
