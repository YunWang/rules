...
import (
	...
	"k8s.io/rules/pkg/client/clientset/versioned/scheme"
)
...
// CrdV1Client is used to interact with features provided by the crd group.
type CrdV1Client struct {
	restClient rest.Interface
}

func (c *CrdV1Client) Rules(namespace string) RuleInterface {
